...
public class SimpleSurvey {
  ...
  public void createSimpleSurvey() {
    try {
      ...
      QualificationRequirement numHITsApprovedQualReq = new QualificationRequirement();
      numHITsApprovedQualReq.setQualificationTypeId(RequesterService.TOTAL_NUMBER_OF_HITS_APPROVED_QUALIFICATION_TYPE_ID);
      numHITsApprovedQualReq.setComparator(Comparator.GreaterThan);
      numHITsApprovedQualReq.setIntegerValue(new int[] { 1000 });
